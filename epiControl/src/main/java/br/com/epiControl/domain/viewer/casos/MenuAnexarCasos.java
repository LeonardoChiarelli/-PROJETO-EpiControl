...
public class MenuAnexarCasos extends JFrame {
    ...
    private JPanel getPanel() {
        ...
        JButton anexarCasoBtn = new JButton("Anexar Casos");
        anexarCasoBtn.setMaximumSize(buttonSize);
        anexarCasoBtn.setFont(buttonFont);

        JButton listarCasosPorCidadeBtn = new JButton("Listar Casos");
        ...
        anexarCasoBtn.addActionListener(e -> {
            SwingUtilities.invokeLater(() -> new MenuCadastrarCasos(registry));
            dispose();
        });
