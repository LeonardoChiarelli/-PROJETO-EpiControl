...
public record DetalhesCasosDTO(Cidade cidade, Doenca doenca, LocalDate dataDeRegistro, LocalDate ultimaAtualizacao, Double numeroDeCasos, Integer numeroDeObitos, Double numeroDeRecuperados, Boolean status) {
